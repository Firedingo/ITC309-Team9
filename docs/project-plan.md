...
|            |              | I-2       | 07/04 - 20/04 | Establish Risk List. Complete Full Description for Critical Core Risky Difficult (CCRD) Use Case. Implement Technical Competency Demonstrator. Create Test Plan. Establish Initial Project Plan. Deliver Life Cycle Objectives Milestone (LCOM). Complete Inception Phase Project Assessment.                                                              |
|            | Elaboration  | E-1       | 21/04 - 02/05 | Mitigate Highest Priority Risk(s). Implement Highest Priority Architectural Element(s) to Support CCRD Use Case. Complete Development Testing for Highest Priority Architectural Element(s).                                                                                                                                                               |
|            |              | E-2       | 03/05 - 13/05 | Mitigate 2nd Highest Priority Risk(s). Implement 2nd Highest Priority Architectural Element(s) to Support CCRD Use Case. Complete Development and Integration Testing for 2nd Highest Priority Architectural Element(s).                                                                                                                                   |
|            |              | E-3       | 14/05 - 25/05 | Mitigate 3rd Highest Priority Risk(s). Implement 3rd Highest Priority Architectural Element(s) to Support CCRD Use Case. Complete Development and Integration Testing for 3rd Highest Priority Architectural Element(s). Deploy Executable Architecture in Trial Environment Complete Internal User Acceptance Testing for CCRD Use Case in Trial Environment.|
...
|            |              | C-2       | 24/07 - 06/08 | Implement 3rd Highest Priority Use Case(s). Complete Development and Integration Testing for 3rd Highest Priority Use Case(s). Complete Internal User Acceptance Testing for 3rd Highest Priority Use Case(s).                                                                                                                                             |
|            |              | C-3       | 07/08 - 20/08 | Implement 4th Highest Priority Use Case(s). Complete Development and Integration Testing for 4th Highest Priority Use Case(s). Complete Internal User Acceptance Testing for 4th Highest Priority Use Case(s).                                                                                                                                             |
