...
We have a good idea of how we are going to achieve our aims. We are going to use a `<insert brief summary of architecture here>`. This is shown in the completed `<insert list of artefacts documenting architecture here>`
